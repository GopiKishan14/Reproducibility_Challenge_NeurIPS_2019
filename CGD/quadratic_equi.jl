...
∇x = ForwardDiff.gradient(x -> f(x,y0), x0)
∇y = ForwardDiff.gradient(y -> g(x0,y), y0)
...
# plot!(pl, l10DistCGDA, label="CGD", linewidth = 5.0)
# plot!(pl, l10DistLCGD, label="LCGD", linewidth = 5.0)
# plot!(pl, l10DistGDA, label="GDA", linewidth = 5.0)

plot!(pl, l10DistConOpt, label="ConOpt", linewidth = 5.0)
plot!(pl, l10DistOGDA, label="OGDA", linewidth = 5.0)


savefig(pl, "./out/exp1/test2/quadratic_equi_alpha$(α)_eta$(η)_gamma$(γ)") 
